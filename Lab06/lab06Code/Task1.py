# Частотні таблиці (попередньо обчислені з набору даних)
P_Yes = 10 / 14
P_No = 4 / 14

# Ймовірності для кожного атрибута для "Yes" та "No"
likelihoods = {
    'Outlook': {
...
def predict_match(outlook, humidity, wind):
    # Обчислення ймовірностей для "Yes"
    ...
    # Обчислення ймовірностей для "No"
...
# Вхідні дані (можна змінювати для різних прогнозів)
outlook = "Overcast"  # Перспектива
humidity = "High" # Вологість
wind = "Weak" # Вітер
